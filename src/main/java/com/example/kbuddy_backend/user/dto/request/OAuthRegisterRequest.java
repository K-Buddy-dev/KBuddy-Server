...
public record OAuthRegisterRequest(@NotNull @Pattern(regexp = "^[a-zA-Z0-9]{3,20}$",message = "닉네임 유효성 검사 실패") String userId, @NotNull @Email(message = "이메일 형식에 맞지 않습니다.") String email, @NotBlank @Size(max = 30) String firstName, @NotBlank @Size(max = 30) String lastName,
								    Country country,  Gender gender, String birthDate,@NotNull String oAuthUid, @NotNull OAuthCategory oAuthCategory) {
